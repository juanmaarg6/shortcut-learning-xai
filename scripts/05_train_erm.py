"""Train the ERM ResNet-50 baseline on Waterbirds."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Train the Waterbirds ERM ResNet-50 baseline."
    )
...
def format_metric(value: float) -> str:
    """Format a metric for compact console output."""
...
def save_checkpoint(
    *,
    ...
    """Save the best model checkpoint and its experiment metadata."""
...
def main() -> None:
    """Run one ERM training experiment."""
    args = parse_args()
    ...
    checkpoint_dir = PROJECT_ROOT / "artifacts" / "checkpoints" / "erm" / run_name
    metrics_dir = PROJECT_ROOT / "results" / "metrics" / "erm" / run_name
